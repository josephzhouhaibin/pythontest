...
public class QueryUserComment{
	  @Test(dataProvider = "dp") 
	  public void queryUserComment(String userid,String productkey,String expectcode,int offset,int limit,int hiddenCondition,int hiddenStart,int hiddenEnd) {
		  String uri;
		  	 uri = "http://gentie.163.com:8181/api/v1//products/"+productkey+"/users/"+userid+"/comments/"+offset+"/"+limit+"/"+hiddenCondition+"/"+hiddenStart+"/"+hiddenEnd;
  ...
  public Object[][] dp() {
	return new Object[][] {
			 //正常请求
		      ...
		      //userid不存在
		      new Object[]{ "1", "eecc698764a1403d846bef6f9a01d90d","404",0,10,100,50,10},
		      //userid格式不正确
		      new Object[]{ "As", "eecc698764a1403d846bef6f9a01d90d","422",0,10,100,50,10},
		      //key不存在
