...
public class QueryNewComment{
	  ...
	  public void queryHotComment(String threadid,String productkey,String expectcode,int offset,int limit,int hiddenCondition,int hiddenStart,int hiddenEnd) {
		  String uri;
		  	 uri = "http://gentie.163.com:8181/api/v1//products/"+productkey+"/threads/"+threadid+"/comments/new/build/"+offset+"/"+limit+"/"+hiddenCondition+"/"+hiddenStart+"/"+hiddenEnd;
