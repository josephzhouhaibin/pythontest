...
public class QueryReplyMyComment {
	@Test(dataProvider = "dp") 
	  public void queryMyComment(String userid,String productkey,String expectcode,int offset,int limit,int hiddenCondition,int hiddenStart,int hiddenEnd) {
		  String uri;
		  uri = "http://gentie.163.com:8181/api/v1//products/"+productkey+"/users/"+userid+"/reply2me/"+offset+"/"+limit+"/"+hiddenCondition+"/"+hiddenStart+"/"+hiddenEnd;
