...
public class VoteComment{
	  ...
	  public void voteComment(String threadid,String productkey,int commentid,String expectcode) {
			 String uri;
			 uri = "http://gentie.163.com:8181/api/v1/products/"+productkey+"/threads/"+threadid+"/comments/"+commentid+"/action/vote";
